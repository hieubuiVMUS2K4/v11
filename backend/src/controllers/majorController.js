...
class MajorController {
  ...
  static async createMajor(req, res) {
    try {
      ...
      ResponseHelper.created(res, 'Tạo ngành thành công', newMajor[0]);
    } catch (error) {
  ...
  static async updateMajor(req, res) {
    try {
      ...
      ResponseHelper.success(res, 'Cập nhật ngành thành công', updatedMajor[0]);
    } catch (error) {
  ...
  static async deleteMajor(req, res) {
    try {
      ...
      ResponseHelper.success(res, 'Xóa ngành thành công');
    } catch (error) {
  ...
  static async bulkDeleteMajors(req, res) {
    try {
      ...
      ResponseHelper.success(res, `Đã xóa ${result.affectedRows} ngành thành công`);
    } catch (error) {
