...
class DepartmentController {
  ...
  static async createDepartment(req, res) {
    try {
      ...
      ResponseHelper.created(res, 'Tạo khoa thành công', newDepartment[0]);
    } catch (error) {
  ...
  static async updateDepartment(req, res) {
    try {
      ...
      ResponseHelper.success(res, 'Cập nhật khoa thành công', updatedDepartment[0]);
    } catch (error) {
  ...
  static async deleteDepartment(req, res) {
    try {
      ...
      ResponseHelper.success(res, 'Xóa khoa thành công');
    } catch (error) {
  ...
  static async bulkDeleteDepartments(req, res) {
    try {
      ...
      ResponseHelper.success(res, `Đã xóa ${result.affectedRows} khoa thành công`);
    } catch (error) {
