...
// POST routes
router.post('/', ValidationMiddleware.validateAcademic, MajorController.createMajor);

// PUT routes
router.put('/:id', ValidationMiddleware.validatePartialAcademic, MajorController.updateMajor);
