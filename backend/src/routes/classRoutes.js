...
// POST routes
router.post('/', ValidationMiddleware.validateAcademic, ClassController.createClass);
router.post('/transfer-students', ClassController.transferStudents);

// PUT routes
router.put('/:id', ValidationMiddleware.validatePartialAcademic, ClassController.updateClass);
